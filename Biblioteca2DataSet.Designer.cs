...
namespace BibliotecaN {
    ...
    public partial class Biblioteca2DataSet : global::System.Data.DataSet {
        ...
        public partial class AuthorDataTable : global::System.Data.TypedTableBase<AuthorRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public AuthorRow AddAuthorRow(string Nume) {
        ...
        public partial class AuthorRow : global::System.Data.DataRow {
            ...
            public string Nume {
                get {
                    return ((string)(this[this.tableAuthor.NumeColumn]));
                }
                set {
                    this[this.tableAuthor.NumeColumn] = value;
                }
            }
        }
...
namespace BibliotecaN.Biblioteca2DataSetTableAdapters {
    ...
    public partial class AuthorTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Author] WHERE (([ID] = @Original_ID) AND ([Nume] = @Original_N" +
                "ume))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Author] ([Nume]) VALUES (@Nume);\r\nSELECT ID, Nume FROM Author " +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Author] SET [Nume] = @Nume WHERE (([ID] = @Original_ID) AND ([Nume]" +
                " = @Original_Nume));\r\nSELECT ID, Nume FROM Author WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Nume FROM dbo.Author";
        ...
        public virtual int Fill(Biblioteca2DataSet.AuthorDataTable dataTable) {
        ...
        public virtual Biblioteca2DataSet.AuthorDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Biblioteca2DataSet.AuthorDataTable dataTable = new Biblioteca2DataSet.AuthorDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Biblioteca2DataSet.AuthorDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Biblioteca2DataSet dataSet) {
